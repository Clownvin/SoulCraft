...
public class CommandQuietItem extends CommandBase {
    ...
    public String getUsage(ICommandSender sender) {
        return "commands.quietitem.usage";
    }
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        soul.setQuieted(true);
        notifyCommandListener(sender, this, "commands.quietitem.success", new Object[]{heldItem.getDisplayName()});
    }
}