...
public class RenderSoulXPOrb extends Render<EntitySoulXPOrb> {
    ...
    public RenderSoulXPOrb(RenderManager renderManagerIn) {
     ...
     */
    @Override
    public void doRender(EntitySoulXPOrb entity, double x, double y, double z, float entityYaw, float partialTicks) {
     ...
     */
    protected ResourceLocation getEntityTexture(EntitySoulXPOrb entity) {
