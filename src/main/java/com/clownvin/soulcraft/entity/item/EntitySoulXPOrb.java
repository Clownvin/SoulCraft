...
public class EntitySoulXPOrb extends Entity {
    ...
    public EntitySoulXPOrb(World worldIn, double x, double y, double z, double expValue) {
        super(worldIn);
    ...
    /**
     * Returns true if it's possible to attack this entity with an soul.
     */
    @Override
