...
public class Personality extends IForgeRegistryEntry.Impl<Personality> implements Weighted {
    ...
    public Personality(float weight, String name, String[] onUse, int useOdds, String[] onKill, int killOdds, String[] onDeath, String[] onLevelUp, String[] onHurt, int hurtOdds, String[] twentyPercent, String[] fivePercent) {
        ...
        setRegistryName(SoulCraft.MOD_ID, name.toLowerCase().replace(" ", "_"));
        this.name = name;
        this.onUse = onUse;
    ...
    public static void createRegistry(RegistryEvent.NewRegistry event) {
        ...
        registry = builder.setName(new ResourceLocation(SoulCraft.MOD_ID, "personalityRegistry"))
    ...
    public static Personality getPersonality() {
        return getPersonality((float) Math.random());
    }

    public static Personality getPersonality(String personality) {
        return registry.getValue(new ResourceLocation(SoulCraft.MOD_ID, personality.toLowerCase().replace(" ", "_")));
    }
